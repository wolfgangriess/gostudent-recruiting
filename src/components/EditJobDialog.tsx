      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <FormField control={form.control} name="externalName" render={({ field }) => (
              <FormItem>
                <FormLabel>External Job Name</FormLabel>
                <FormControl><Input {...field} /></FormControl>
              </FormItem>
            )} />
            ...
            <div className="grid grid-cols-[1fr_auto] gap-2 items-end">
              <FormField control={form.control} name="requisitionId" render={({ field }) => (
                <FormItem>
                  <FormLabel>Requisition ID</FormLabel>
                  <FormControl><Input {...field} /></FormControl>
                </FormItem>
              )} />
              <Button type="button" variant="outline" className="h-10" onClick={() => form.setValue("requisitionId", `REQ-${Date.now().toString().slice(-6)}`)}>
            ...
            <FormField control={form.control} name="jobDescriptionLink" render={({ field }) => (
              <FormItem>
            ...
            <UserPicker selectedIds={hiringTeamIds} onChange={setHiringTeamIds} label="Hiring Team (Full Access)" placeholder="Search team members…" />
            <UserPicker selectedIds={visibilityIds} onChange={setVisibilityIds} label="Job Visibility (Read-only)" placeholder="Add employees for visibility…" />
